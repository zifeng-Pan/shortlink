package org.personalproj.shortlink.project.common.convention.errorcode;

/**
 * @BelongsProject: shortlink
 * @BelongsPackage: org.personalproj.shortlink.admin.common.convention.errorcode
 * @Author: PzF
 * @CreateTime: 2024-01-27  16:01
 * @Description: 枚举基本错误验证码
 * @Version: 1.0
 */
public enum BaseErrorCode implements IStatusCode {
